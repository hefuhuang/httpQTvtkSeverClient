...
QT_MOC_LITERAL(4, 33, 7) // "m_Reply"

    },
    "NetUtil\0Finished\0\0QNetworkReply*\0"
    "m_Reply"
};
...
void NetUtil::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NetUtil *_t = static_cast<NetUtil *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (NetUtil::*_t)(QNetworkReply * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetUtil::Finished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NetUtil::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetUtil.data,
      qt_meta_data_NetUtil,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NetUtil::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetUtil.stringdata0))
        return static_cast<void*>(const_cast< NetUtil*>(this));
...
// SIGNAL 0
void NetUtil::Finished(QNetworkReply * _t1)
{
